                    ...
                    <div class="right">
                        <div class="form-wrapper">
                            <form class="fck" action="form/form.php" method="POST"><input type="hidden" name="type" value="catalog">
                                <div class="form-title" contenteditable="true" id="id-block6">Получить каталог</div>
                                ...
                                <?php if ($ini['catalog_file']) { ?><p class="bot" contenteditable="true" id="id-block8">Каталог придет на почту сразу</p><?php } ?>
                            </form>
                        </div>
                    </div>
                </div>
...
нашу мебель</p>
            ...
            <div class="well">
                <div class="inner">
                    ...
                    <div contenteditable="true" id="id-block11"><ul class="clearfix"><li>
                            ...
                            <p>
								Экокожу и ткань легко чистить и мыть. При сильных загрязнениях подойдут и обычные чистящие средства.
                            </p>
                        </li>
                        <li>
                            ...
                            <p>
								Потому что мы используем только качественный наполнитель. Гранулированный пенополистирол не впитывает влагу, «дышит», сохраняет тепло и форму.
                            </p>
                        </li>
                        <li>
                            ...
                            <p>
                                Мы предлагаем большой выбор цвета и материала для любых интерьеров. Чехол из экокожи очень прочный и износостойкий. Наши кресла прослужат вам долго, где бы вы их не использовали.
                            </p>
                        </li>
                        <li>
                            ...
                            <p>
                                Кресла с ортопедическим эффектом. Принимают форму тела, разгружая позвоночник и мышцы спины. Благодаря бескаркасной технологии вы всегда найдете удобное положение.
                            </p>
                        </li>
                        <li>
                            ...
                            <p>
                                Мы используем высококачественные и экологически чистые материалы, которые сертифицированы и безвредны для детей. Кроме того, к ним действительно приятно прикасаться.
                            </p>
                        </li>
                    </ul></div>
				</div>
            ...
            <div class="scheme">
                <div class="inner">
                    ...
                    <div contenteditable="true" id="id-block13"><ul class="clearfix"><li class="width134">
                            Вы отправляете<br>
                        ...
                        <li class="sep">
                        </li><li class="width142"><br>
							Наш менеджер <br> связывается с вами.
                        </li>
                        <li class="sep">
                        ...
                        <li class="sep">
                            ...
                            для вас время доставки.
                        </li>
                        <li class="sep">
                        </li><li class="end width178">
                            Мы доставляем кресло<br>
                            точно в срок.<br>
                            Оплата любым <br>способом 
                            при получени <br>заказа!
                        </li>
                    </ul></div>
				</div>
            </div>
            <div class="contact">
                <div class="inner">
                    <form action="form/form.php" method="POST"><input type="hidden" name="type" value="catalog">
                        <div class="title" contenteditable="true" id="id-block14">Получить весь каталог</div>
            ...
            <div class="footer">
                <div>
                    <div class="inner clearfix">
                        ...
                        <span class="right">Лэндинг сделан в <a target="_blank" href="http://www.youlp.ru/">www.youlp.ru</a>
