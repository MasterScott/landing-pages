$(function(){
	...
	$(".fixed-img").backstretch("i/main_tite.png");
	...
	if ($(".catalogue_block").length){
		$(".catalogue .item span").click(function () {
			$.colorbox({
				inline: true,
				href: ".block-form",
				innerWidth: "304px",
	...
	ib.vwo_wrapper.on('click','.open_modal',function(){
