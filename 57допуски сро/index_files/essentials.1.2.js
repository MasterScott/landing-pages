...
//если вы обладатель счаслтивого браузера
...
function ltxLoadSettings(baseUrl, siteId, opt_callback) {
  ltxLoadScript(baseUrl + 'js/sites/' + siteId + '.js', opt_callback);
}
