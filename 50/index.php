			...
			<div class="h-top-row">
				<div class="conteiner clr">
					<div class="logo" id="ib-block1" contenteditable="true">
						<img src="images/logo.png" alt="" width="160" height="34"></div><!--close logo-->
				...
				<div class="conteiner">
					...
					<div class="main-offer-block">
						...
						<div class="action-block">
							...
							<p><strong>успейте заказать сейчас</strong></p>
					...
					<div class="rev left-fl">
						<div class="rev-head">
							<div class="img-caption clr" id="ib-block10" contenteditable="true">
								<img src="images/r-photo.jpg" alt="" width="156" height="156"><h3>Михаил Липницкий</h3>
