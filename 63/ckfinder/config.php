...
defined('APPLICATION_PATH')
    || define('APPLICATION_PATH', $_SERVER["DOCUMENT_ROOT"].'/library/');
...
require_once APPLICATION_PATH . 'Zend/Auth.php';
*/
function CheckAuthentication()
{
	...
	return (!$auth->hasIdentity()) ? false : true;*/
...
function GetBasePath() {
    return substr(__FILE__, 0, strlen(__FILE__) - strlen(strrchr(__FILE__, "/")));
} 
$baseDir = GetBasePath().'/userfiles/';//resolveUrl($baseUrl);
